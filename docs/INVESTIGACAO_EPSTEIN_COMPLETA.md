...
```mermaid
graph TB
    subgraph "JEFFREY EPSTEIN - Centro da Rede"
        JE[Jeffrey Epstein<br/>1953-2019<br/>Financista/Predador Sexual]
    end

    subgraph "PROPRIEDADES"
        PB[Palm Beach<br/>358 El Brillo Way<br/>Centro de operacoes FL]
        NY[Manhattan<br/>9 E 71st Street<br/>Townhouse $77M]
        LSJ[Little St. James<br/>Ilha Privada USVI<br/>72 acres]
        ZR[Zorro Ranch<br/>New Mexico<br/>10,000 acres]
        PARIS[Paris<br/>Apartamento]
    end
...
```mermaid
graph LR
    subgraph "CO-CONSPIRADORES COM IMUNIDADE"
        SK[Sarah Kellen<br/>Agendadora de 'massagens'<br/>131 docs]
        NM[Nadia Marcinkova<br/>'Sex slave' comprada<br/>488 docs]
        LG[Lesley Groff<br/>Assistente executiva<br/>Milhares de docs]
        AR[Adriana Ross<br/>Co-conspiradora<br/>24 docs]
    end

    subgraph "FORNECEDORES DE VITIMAS"
        JLB[Jean-Luc Brunel<br/>MC2 Models<br/>616 docs<br/>MORTO 2022]
        HR[Haley Robson<br/>Recrutadora<br/>13 docs]
    end
...
```mermaid
flowchart TD
    A[Recrutamento em escolas<br/>Royal Palm Beach HS] --> B[Agendamento<br/>Sarah Kellen liga de NY]
    B --> C[Chegada<br/>Menina entra pela cozinha]
    C --> D[Mesa de massagem<br/>Quarto de Epstein]
    D --> E[Abuso sexual<br/>'Massagem' com penetracao]
    E --> F[Pagamento<br/>$200-300]
    F --> G[Recrutamento piramidal<br/>'Bring your pretty friends']
    G --> A
...
```mermaid
graph TB
    JE[JEFFREY EPSTEIN<br/>Centro da Rede]

    subgraph "REALEZA/POLITICA"
        PA[Prince Andrew<br/>891 docs<br/>Acusado por Virginia]
        BC[Bill Clinton<br/>556 docs<br/>'32 voos']
        DT[Donald Trump<br/>383 docs<br/>Mar-a-Lago]
        AD[Alan Dershowitz<br/>447 docs<br/>Advogado/Acusado]
        EB[Ehud Barak<br/>Ex-PM Israel]
    end

    subgraph "FINANCAS"
        LW[Les Wexner<br/>97 docs<br/>$77M townhouse]
        LB[Leon Black<br/>2159 docs<br/>$158M pagos]
        JS[Jes Staley<br/>JP Morgan CEO]
    end

    subgraph "CO-CONSPIRADORES"
        GM[Ghislaine Maxwell<br/>5109 docs<br/>CONDENADA]
        SK[Sarah Kellen<br/>131 docs]
        JLB[Jean-Luc Brunel<br/>616 docs<br/>MORTO]
    end
...
```mermaid
graph TB
    subgraph "VITIMAS IDENTIFICADAS"
        VRG[Virginia Roberts Giuffre<br/>58 docs<br/>Recrutada aos 16]
        CW[Courtney Wild<br/>6 docs<br/>Recrutada adolescente]
        MF[Maria Farmer<br/>7 docs<br/>Artista]
        AF[Annie Farmer<br/>4 docs<br/>Irma de Maria]
        SR[Sarah Ransome<br/>7 docs<br/>Processou Maxwell]
        JD[Jane Doe<br/>1638 docs<br/>Vitimas anonimas]
        VB[Vitima Brasileira<br/>Nascida 1988<br/>Recrutou 20-50 meninas]
        VD[Vitima do Diario<br/>16-20 anos<br/>Programa de eugenia]
    end

    subgraph "ABUSADORES PRIMARIOS"
        JE[JEFFREY EPSTEIN<br/>Predador principal]
        GM[GHISLAINE MAXWELL<br/>Recrutadora/Abusadora]
    end

    subgraph "ABUSADORES NOMEADOS"
        PA[Prince Andrew]
        AD[Alan Dershowitz]
        BC[Bill Clinton]
        LB[Leon Black]
...
```mermaid
graph LR
    subgraph "FONTES DE RIQUEZA"
        LW[Les Wexner<br/>$77M townhouse]
        LB[Leon Black<br/>$158M+]
        PONZI[Towers Financial<br/>$450M Ponzi]
    end

    JE[JEFFREY EPSTEIN]

    subgraph "DESTINOS"
        PROP[Propriedades<br/>5 residencias]
        AVIAO[Avioes<br/>Boeing 727 + outros]
        VITIMAS[Vitimas<br/>$200-300 por 'massagem']
        STAFF[Staff<br/>Maxwell, Kellen, etc.]
        SILENCIO[Silencio<br/>Acordos, advogados]
    end
...
```mermaid
gantt
    title Linha do Tempo do Caso Epstein
    dateFormat  YYYY

    section Crimes
    Esquema Ponzi Towers Financial    :1987, 1993
    Compra da ilha LSJ                :1998, 1998
    Periodo de abusos documentados    :2001, 2005

    section Justica
    Investigacao Palm Beach           :2005, 2006
    Non-Prosecution Agreement         :2007, 2008
    Prisao estadual (13 meses)        :2008, 2009
    Processo de vitimas (CVRA)        :2008, 2019

    section Final
    Prisao federal SDNY               :2019, 2019
    Morte na prisao                   :milestone, 2019, 0d
    Julgamento Maxwell                :2021, 2021
    Morte Brunel                      :milestone, 2022, 0d
```
